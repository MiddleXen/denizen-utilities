package com.isnsest.denizenutilities.extensions.nms;
...
public class FixedEntityHelper1_21 extends EntityHelperImpl {
    ...
    public static void patch() {
        try {
            ...
            helperField.set(null, new FixedEntityHelper1_21());
